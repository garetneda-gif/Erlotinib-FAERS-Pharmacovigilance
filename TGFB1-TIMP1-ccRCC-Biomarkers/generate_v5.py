#!/usr/bin/env python3
"""Generate two-column paginated HTML v5 - optimized layout with LH tuning.

Key changes from v4:
- P4: Add GEPIA2 text after Fig 4 to fill page
- P5: Figs 5+6 side-by-side + Results 3.4 P1+P2 text
- P6: Fig 7 + ROC + Pearson text (more text packed)
- P7: TIMP1 enrichment + Fig 8 + Results 3.5 P1 intro
- Per-page line-height tuning for all pages
Target: 13 pages, minimize gaps
"""
...
def page2():
    """Methods 2.1-2.7 (all methods)."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.47;">
...
def page4():
    """Results 3.3 + Fig 4 + GEPIA2 validation text."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.7;">
...
def page5():
    """Figs 5+6 side-by-side + Results 3.4 P1+P2."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.9;">
...
def page7():
    """Fig 8 + TIMP1 enrichment + Results 3.5 intro."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.7;">
...
def page8():
    """Fig 9 + Table 2 + Results 3.5 P2 + Fig 10."""
    return f'''
<div class="page">
{header()}
...
if __name__ == "__main__":
    ...
    for path in [out1, out2]:
        with open(path, "w", encoding="utf-8") as f:
            f.write(html)
    print(f"Generated {len(html):,} bytes, 13 pages")
    print(f"  -> {out1}")
    print(f"  -> {out2}")
