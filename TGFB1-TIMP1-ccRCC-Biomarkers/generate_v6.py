...
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.99;">
...
{header()}
    <div class="page-content two-column" style="line-height:1.99;">
        ...
        <div class="side-by-side-figures" style="margin:5mm 0 35mm;">
            <figure id="fig-1" style="margin:0;">
                <img src="{IMG_BASE}/Figure 1.jpg" alt="Figure 1">
                <figcaption><span class="fig-label">Figure 1</span> {FIG_CAP[1]}</figcaption>
            </figure>
            <figure id="fig-2" style="margin:0;">
                <img src="{IMG_BASE}/Figure 2.jpg" alt="Figure 2">
                <figcaption><span class="fig-label">Figure 2</span> {FIG_CAP[2]}</figcaption>
            </figure>
        </div>
...
{header()}
    <div class="page-content two-column" style="line-height:1.99;">
        <figure style="column-span:all;margin:5mm 0 31mm;">
                <img src="{IMG_BASE}/Figure 3.jpg" alt="Figure 3" style="width:100%;height:auto;display:block;max-height:120mm;object-fit:contain;">
                <figcaption><span class="fig-label">Figure 3</span> {FIG_CAP[3]}</figcaption>
        </figure>
...
{header()}
    <div class="page-content two-column" style="line-height:1.99;">
        <figure style="column-span:all;margin:5mm 0 21mm;">
                <img src="{IMG_BASE}/Figure 4.jpg" alt="Figure 4" style="width:100%;height:auto;display:block;max-height:120mm;object-fit:contain;">
                <figcaption><span class="fig-label">Figure 4</span> {FIG_CAP[4]}</figcaption>
        </figure>
...
def page6():
    """Figs 5+6 side-by-side + ROC text (flexbox manual two-column)."""
    return f'''
<div class="page">
{header()}
    <div class="page-content" style="display:flex;flex-direction:column;line-height:1.99;">
        {side_by_side(5, FIG_CAP[5], 6, FIG_CAP[6])}
        <div style="flex:1;display:flex;gap:var(--column-gap);text-align:justify;min-height:0;">
            <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:flex-end;">
                <p class="no-indent">To evaluate the expression specificity of TGFB1 and TIMP1 in ccRCC, receiver operating characteristic (ROC) curves were constructed based on 532 ccRCC samples and 72 normal samples from the TCGA database. The area under the curve (AUC) was 0.883 for TGFB1</p>
            </div>
            <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:flex-end;">
                <p class="no-indent">(Figure 8A) and 0.871 for TIMP1 (Figure 8B), indicating that both genes are specifically enriched in ccRCC and may serve as potential diagnostic biomarkers.</p>
            </div>
        </div>
    </div>
{footer(6)}
...
def page8():
    """Fig 9 + Results 3.5 intro (flexbox manual two-column)."""
    return f'''
<div class="page">
{header()}
    <div class="page-content" style="display:flex;flex-direction:column;line-height:1.99;">
        ...
        <div style="flex:1;display:flex;gap:var(--column-gap);text-align:justify;min-height:0;">
            <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:flex-end;">
                ...
                <p class="no-indent">Finally, active compounds targeting TGFB1 and TIMP1 were identified using the Enrichr database. Bosentan and Ramipril exhibited favorable binding scores with TGFB1, whereas Meclizine and AM-630 showed good binding scores with TIMP1 (Table 2). To validate these interactions, the crystal structures of TGFB1 and TIMP1 were obtained from the PDB database, and the 2D structures of</p>
            </div>
            <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:flex-end;">
                <p class="no-indent">Bosentan, Ramipril, Meclizine, and AM-630 were retrieved from the PubChem database.</p>
            </div>
        </div>
    </div>
{footer(8)}
...
{header()}
    <div class="page-content two-column" style="line-height:1.99;">
        <div class="table-wrapper" id="tbl-2" style="margin:5mm 0 8mm;">
        ...
        <figure style="column-span:all;margin:5mm 0 8mm;">
                <img src="{IMG_BASE}/Figure 10.jpg" alt="Figure 10" style="width:100%;height:auto;display:block;max-height:120mm;object-fit:contain;">
                <figcaption><span class="fig-label">Figure 10</span> {FIG_CAP[10]}</figcaption>
        </figure>
...
if __name__ == "__main__":
    html = build_html()
    out1 = os.path.join(OUTPUT_DIR, "two-column-TGFB1-TIMP1-ccRCC-Biomarkers.html")
