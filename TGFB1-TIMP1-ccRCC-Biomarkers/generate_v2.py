...
CSS = """
        ...
        * { box-sizing: border-box; }
        ...
        a {
            ...
            color: #005a8c; text-decoration: none;
        }
        .page {
        ...
        .page-header {
            ...
            left: var(--margin-left); right: var(--margin-right);
            font-size: 8pt; text-transform: uppercase; text-align: right;
            color: #000; border-bottom: 0.5pt solid #ccc; padding-bottom: 2mm;
        }
        .page-footer {
            position: absolute; bottom: 8mm;
            left: var(--margin-left); right: var(--margin-right);
            font-size: 9pt; text-align: center; color: #000;
            border-top: 0.5pt solid #000; padding-top: 2mm;
        }
        .page-footer .page-num { position: absolute; right: 0; top: 2mm; }
        .page-content { height: var(--content-height); overflow: hidden; }
        .two-column {
            column-count: 2; column-gap: var(--column-gap);
            column-fill: auto; text-align: justify;
            orphans: 1; widows: 1;
        }
        .column-span-all { column-span: all; }
        .page-content, .page-content p, .page-content h1, .page-content h2,
        .page-content figcaption, .page-content .table-caption, .page-content .references div {
            line-break: strict; hanging-punctuation: allow-end last;
            text-wrap: pretty; text-spacing-trim: trim-all; text-autospace: no-autospace;
        }
        h1.section-title {
            font-family: Arial, Helvetica, sans-serif;
            font-size: 11pt; font-weight: 600; letter-spacing: 0.04em;
        ...
        h2.subsection-title {
            font-family: Arial, Helvetica, sans-serif;
            font-size: 9.5pt; font-weight: bold; text-align: left;
            margin: 3mm 0 2mm 0;
        }
        p { margin: 0 0 3mm 0; text-indent: 1em; }
        p.no-indent { text-indent: 0; }
        figure { column-span: all; margin: 5mm 0; width: 100%; }
        figure img {
            width: 100%; height: auto; display: block;
            max-height: 120mm; object-fit: contain;
        }
        figcaption { font-size: 8.5pt; margin-top: 2mm; text-align: left; line-height: 1.3; color: #222; }
        figcaption .fig-label { font-weight: bold; color: #005a8c; }
        .table-wrapper { column-span: all; margin: 5mm 0 6mm; width: 100%; }
        .table-wrapper.no-span { column-span: none; }
        .table-caption { font-size: 8.5pt; margin-bottom: 2mm; text-align: left; color: #222; }
        .table-caption .tbl-label { font-weight: bold; color: #005a8c; }
        table {
            width: 100%; border-collapse: collapse;
            font-size: 8.5pt; line-height: 1.3;
            border-top: 1.5pt solid #000; border-bottom: 1.5pt solid #000;
        }
        th { border-bottom: 0.5pt solid #000; font-weight: bold; text-align: left; padding: 1.5mm 2mm; vertical-align: bottom; }
        td { padding: 1mm 2mm; vertical-align: top; }
        .references { font-size: 8pt; }
        .references div { margin-bottom: 2mm; }
        .side-by-side-figures {
            column-span: all; display: flex; gap: 4mm; margin: 5mm 0;
        }
        .side-by-side-figures figure { flex: 1; margin: 0; min-width: 0; }
        @media print {
            body { padding: 0; margin: 0; background: #fff; }
            .page {
                width: var(--page-width); height: var(--page-height);
                margin: 0; padding: var(--margin-top) var(--margin-right) var(--margin-bottom) var(--margin-left);
...
# ============================================================
REFS = [
    '[1] Turajlic S, Swanton C, Boshoff C: <b><a href="https://pubmed.ncbi.nlm.nih.gov/30217855/">Kidney cancer: The next decade</a></b>. <i>J Exp Med</i> 2018, <b>215</b>(10):2477-2479.',
    '[2] Sung H, Ferlay J, Siegel RL, Laversanne M, Soerjomataram I, Jemal A, Bray F: <b><a href="https://pubmed.ncbi.nlm.nih.gov/33538338/">Global Cancer Statistics 2020: GLOBOCAN Estimates of Incidence and Mortality Worldwide for 36 Cancers in 185 Countries</a></b>. <i>CA Cancer J Clin</i> 2021, <b>71</b>(3):209-249.',
    '[3] Atkins MB, Tannir NM: <b><a href="https://pubmed.ncbi.nlm.nih.gov/30173085/">Current and emerging therapies for first-line treatment of metastatic clear cell renal cell carcinoma</a></b>. <i>Cancer Treat Rev</i> 2018, <b>70</b>:127-137.',
    '[4] Jonasch E, Walker CL, Rathmell WK: <b><a href="https://pubmed.ncbi.nlm.nih.gov/33144689/">Clear cell renal cell carcinoma ontogeny and mechanisms of lethality</a></b>. <i>Nat Rev Nephrol</i> 2021, <b>17</b>(4):245-261.',
    '[5] Severins I, Joo C, van Noort J: <b><a href="https://pubmed.ncbi.nlm.nih.gov/35561688/">Exploring molecular biology in sequence space: The road to next-generation single-molecule biophysics</a></b>. <i>Mol Cell</i> 2022, <b>82</b>(10):1788-1805.',
    '[6] Freire PP, Fernandez GJ, de Moraes D, Cury SS, Dal Pai-Silva M, Dos Reis PP, Rogatto SR, Carvalho RF: <b><a href="https://doi.org/10.1002/jcsm.12565">The expression landscape of cachexia-inducing factors in human cancers</a></b>. <i>J Cachexia Sarcopenia Muscle</i> 2020, <b>11</b>(4):947-961.',
    '[7] Barrett T, Troup DB, Wilhite SE, Ledoux P, Evangelista C, Kim IF, Tomashevsky M, Marshall KA, Phillippy KH, Sherman PM <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/21097893/">NCBI GEO: archive for functional genomics data sets&mdash;10 years on</a></b>. <i>Nucleic Acids Res</i> 2011, <b>39</b>(Database issue):D1005-1010.',
    '[8] The Gene Ontology Consortium: <b><a href="https://pubmed.ncbi.nlm.nih.gov/30395331/">The Gene Ontology Resource: 20 years and still GOing strong</a></b>. <i>Nucleic Acids Res</i> 2019, <b>47</b>(D1):D330-D338.',
    '[9] Kanehisa M, Furumichi M, Tanabe M, Sato Y, Morishima K: <b><a href="https://pubmed.ncbi.nlm.nih.gov/27899662/">KEGG: new perspectives on genomes, pathways, diseases and drugs</a></b>. <i>Nucleic Acids Res</i> 2017, <b>45</b>(D1):D353-D361.',
    '[10] Chen L, Lu D, Sun K, Xu Y, Hu P, Li X, Xu F: <b><a href="https://pubmed.ncbi.nlm.nih.gov/30654001/">Identification of biomarkers associated with diagnosis and prognosis of colorectal cancer patients based on integrated bioinformatics analysis</a></b>. <i>Gene</i> 2019, <b>692</b>:119-125.',
    '[11] Otasek D, Morris JH, Boucas J, Pico AR, Demchak B: <b><a href="https://pubmed.ncbi.nlm.nih.gov/31477170/">Cytoscape Automation: empowering workflow-based network analysis</a></b>. <i>Genome Biol</i> 2019, <b>20</b>(1):185.',
    '[12] Fang HT, El Farran CA, Xing QR, Zhang LF, Li H, Lim B, Loh YH: <b><a href="https://pubmed.ncbi.nlm.nih.gov/29670118/">Global H3.3 dynamic deposition defines its bimodal role in cell fate transition</a></b>. <i>Nat Commun</i> 2018, <b>9</b>(1):1537.',
    '[13] Su W, Zhao Y, Wei Y, Zhang X, Ji J, Yang S: <b><a href="https://pubmed.ncbi.nlm.nih.gov/34122426/">Exploring the Pathogenesis of Psoriasis Complicated With Atherosclerosis via Microarray Data Analysis</a></b>. <i>Front Immunol</i> 2021, <b>12</b>:667690.',
    '[14] Huang X, Tang T, Zhang G, Liang T: <b><a href="https://pubmed.ncbi.nlm.nih.gov/33685460/">Identification of tumor antigens and immune subtypes of cholangiocarcinoma for mRNA vaccine development</a></b>. <i>Mol Cancer</i> 2021, <b>20</b>(1):50.',
    '[15] Chandrashekar DS, Bashel B, Balasubramanya SAH, Creighton CJ, Ponce-Rodriguez I, Chakravarthi B, Varambally S: <b><a href="https://pubmed.ncbi.nlm.nih.gov/28732212/">UALCAN: A Portal for Facilitating Tumor Subgroup Gene Expression and Survival Analyses</a></b>. <i>Neoplasia</i> 2017, <b>19</b>(8):649-658.',
    '[16] Sun CC, Li SJ, Hu W, Zhang J, Zhou Q, Liu C, Li LL, Songyang YY, Zhang F, Chen ZL <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/31010740/">Comprehensive Analysis of the Expression and Prognosis for E2Fs in Human Breast Cancer</a></b>. <i>Mol Ther</i> 2019, <b>27</b>(6):1153-1165.',
    '[17] Di W, Fan W, Wu F, Shi Z, Wang Z, Yu M, Zhai Y, Chang Y, Pan C, Li G <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/34881489/">Clinical characterization and immunosuppressive regulation of CD161 (KLRB1) in glioma through 916 samples</a></b>. <i>Cancer Sci</i> 2022, <b>113</b>(2):756-769.',
    '[18] Li X, Wei S, Niu S, Ma X, Li H, Jing M, Zhao Y: <b><a href="https://pubmed.ncbi.nlm.nih.gov/35303581/">Network pharmacology prediction and molecular docking-based strategy to explore the potential mechanism of Huanglian Jiedu Decoction against sepsis</a></b>. <i>Comput Biol Med</i> 2022, <b>144</b>:105389.',
    '[19] Rydzanicz M, Wrzesinski T, Bluyssen HA, Wesoly J: <b><a href="https://pubmed.ncbi.nlm.nih.gov/23933176/">Genomics and epigenomics of clear cell renal cell carcinoma: recent developments and potential applications</a></b>. <i>Cancer Lett</i> 2013, <b>341</b>(2):111-126.',
    '[20] Phallen J, Sausen M, Adleff V, Leal A, Hruban C, White J, Anagnostou V, Fiksel J, Cristiano S, Papp E <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/28814544/">Direct detection of early-stage cancers using circulating tumor DNA</a></b>. <i>Sci Transl Med</i> 2017, <b>9</b>(403).',
    '[21] Henze AT, Acker T: <b><a href="https://pubmed.ncbi.nlm.nih.gov/20603601/">Feedback regulators of hypoxia-inducible factors and their role in cancer biology</a></b>. <i>Cell Cycle</i> 2010, <b>9</b>(14):2749-2763.',
    '[22] Cowman SJ, Fuja DG, Liu X-D, Tidwell RSS, Kandula N, Sirohi D, Agarwal AM, Emerson LL, Tripp SR, Mohlman JS <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/32586940/">Macrophage HIF-1&alpha; Is an Independent Prognostic Indicator in Kidney Cancer</a></b>. <i>Clin Cancer Res</i> 2020, <b>26</b>(18):4970-4982.',
    '[23] Reustle A, Di Marco M, Meyerhoff C, Nelde A, Walz JS, Winter S, Kandabarau S, Buttner F, Haag M, Backert L <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/32228647/">Integrative -omics and HLA-ligandomics analysis to identify novel drug targets for ccRCC immunotherapy</a></b>. <i>Genome Med</i> 2020, <b>12</b>(1):32.',
    '[24] Schaeffeler E, Buttner F, Reustle A, Klumpp V, Winter S, Rausch S, Fisel P, Hennenlotter J, Kruck S, Stenzl A <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/29452772/">Metabolic and Lipidomic Reprogramming in Renal Cell Carcinoma Subtypes Reflects Regions of Tumor Origin</a></b>. <i>Eur Urol Focus</i> 2019, <b>5</b>(4):608-618.',
    '[25] He B, Xu T, Pan B, Pan Y, Wang X, Dong J, Sun H, Xu X, Liu X, Wang S: <b><a href="https://pubmed.ncbi.nlm.nih.gov/30479570/">Polymorphisms of TGFBR1, TLR4 are associated with prognosis of gastric cancer in a Chinese population</a></b>. <i>Cancer Cell Int</i> 2018, <b>18</b>:191.',
    '[26] Takahara T, Tsuyuki T, Satou A, Wada E, Sakurai K, Ueda R, Tsuzuki T: <b><a href="https://pubmed.ncbi.nlm.nih.gov/35112134/">TGFB1 mRNA expression is associated with poor prognosis and specific features of inflammation in ccRCC</a></b>. <i>Virchows Arch</i> 2022, <b>480</b>(3):635-643.',
    '[27] Sun S, Su D, Dong T, Wang B, Ji X, Chu L, Lu S, Zhang T, Sun X, Liu Y <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/41088271/">Mitochondrial ribosomal protein L12 mediates metabolic reorganization in clear cell renal cell carcinoma by regulating mitochondrial biosynthesis</a></b>. <i>Cell Commun Signal</i> 2025, <b>23</b>(1):435.',
    '[28] Wu P, Geng B, Chen Q, Zhao E, Liu J, Sun C, Zha C, Shao Y, You B, Zhang W <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/32999004/">Tumor Cell-Derived TGFbeta1 Attenuates Antitumor Immune Activity of T Cells via Regulation of PD-1 mRNA</a></b>. <i>Cancer Immunol Res</i> 2020, <b>8</b>(12):1470-1484.',
    '[29] Chang NS: <b><a href="https://pubmed.ncbi.nlm.nih.gov/9850732/">Transforming growth factor-beta protection of cancer cells against tumor necrosis factor cytotoxicity is counteracted by hyaluronidase (review)</a></b>. <i>Int J Mol Med</i> 1998, <b>2</b>(6):653-659.',
    '[30] Dias F, Teixeira AL, Nogueira I, Morais M, Maia J, Bodo C, Ferreira M, Vieira I, Silva J, Lobo J <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/32610589/">Plasma Extracellular Vesicle-Derived TIMP-1 mRNA as a Prognostic Biomarker in Clear Cell Renal Cell Carcinoma: A Pilot Study</a></b>. <i>Int J Mol Sci</i> 2020, <b>21</b>(13).',
    '[31] Dias F, Teixeira AL, Nogueira I, Morais M, Maia J, Bodo C, Ferreira M, Vieira I, Silva J, Lobo J <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/32610589/">Plasma Extracellular Vesicle-Derived TIMP-1 mRNA as a Prognostic Biomarker in Clear Cell Renal Cell Carcinoma: A Pilot Study</a></b>. <i>Int J Mol Sci</i> 2020, <b>21</b>(13).',
    '[32] Shang L, Liu HJ, Hao JJ, Jiang YY, Shi F, Zhang Y, Cai Y, Xu X, Jia XM, Zhan QM <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/25337715/">A panel of overexpressed proteins for prognosis in esophageal squamous cell carcinoma</a></b>. <i>PLoS One</i> 2014, <b>9</b>(10):e111045.',
    '[33] Thomas DD, Heinecke JL, Ridnour LA, Cheng RY, Kesarwala AH, Switzer CH, McVicar DW, Roberts DD, Glynn S, Fukuto JM <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/26117324/">Signaling and stress: The redox landscape in NOS2 biology</a></b>. <i>Free Radic Biol Med</i> 2015, <b>87</b>:204-225.',
    '[34] Chen J, Gu Y, Lin F, Yang H, Zhu W, Ma J, Lin S: <b><a href="https://pubmed.ncbi.nlm.nih.gov/12150723/">Endothelin receptor antagonist combined with a calcium channel blocker attenuates renal injury in spontaneous hypertensive rats with diabetes</a></b>. <i>Chin Med J (Engl)</i> 2002, <b>115</b>(7):972-978.',
    '[35] Tzanidis A, Lim S, Hannan RD, See F, Ugoni AM, Krum H: <b><a href="https://pubmed.ncbi.nlm.nih.gov/11343419/">Combined angiotensin and endothelin receptor blockade attenuates adverse cardiac remodeling post-myocardial infarction in the rat: possible role of transforming growth factor beta(1)</a></b>. <i>J Mol Cell Cardiol</i> 2001, <b>33</b>(5):969-981.',
    '[36] Soldano S, Pizzorni C, Paolino S, Trombetta AC, Montagna P, Brizzolara R, Ruaro B, Sulli A, Cutolo M: <b><a href="https://pubmed.ncbi.nlm.nih.gov/27846260/">Alternatively Activated (M2) Macrophage Phenotype Is Inducible by Endothelin-1 in Cultured Human Macrophages</a></b>. <i>PLoS One</i> 2016, <b>11</b>(11):e0166433.',
    '[37] Caputo I, Caroccia B, Frasson I, Poggio E, Zamberlan S, Morpurgo M, Seccia TM, Cali T, Brini M, Richter SN <i>et al</i>: <b><a href="https://pubmed.ncbi.nlm.nih.gov/35563515/">Angiotensin II Promotes SARS-CoV-2 Infection via Upregulation of ACE2 in Human Bronchial Cells</a></b>. <i>Int J Mol Sci</i> 2022, <b>23</b>(9).',
    '[38] Gross O, Beirowski B, Koepke ML, Kuck J, Reiner M, Addicks K, Smyth N, Schulze-Lohoff E, Weber M: <b><a href="https://pubmed.ncbi.nlm.nih.gov/12631109/">Preemptive ramipril therapy delays renal failure and reduces renal fibrosis in COL4A3-knockout mice with Alport syndrome</a></b>. <i>Kidney Int</i> 2003, <b>63</b>(2):438-446.',
    '[39] Gohil VM, Offner N, Walker JA, Sheth SA, Fossale E, Gusella JF, MacDonald ME, Neri C, Mootha VK: <b><a href="https://pubmed.ncbi.nlm.nih.gov/20977989/">Meclizine is neuroprotective in models of Huntington\'s disease</a></b>. <i>Hum Mol Genet</i> 2011, <b>20</b>(2):294-300.',
    '[40] Hosohata K, Quock RM, Hosohata Y, Burkey TH, Makriyannis A, Consroe P, Roeske WR, Yamamura HI: <b><a href="https://pubmed.ncbi.nlm.nih.gov/9284087/">AM630 is a competitive cannabinoid receptor antagonist in the guinea pig brain</a></b>. <i>Life Sci</i> 1997, <b>61</b>(9):PL115-118.',
]
