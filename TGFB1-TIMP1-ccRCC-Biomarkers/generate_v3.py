#!/usr/bin/env python3
"""Generate two-column paginated HTML v3 - conservative figure placement."""
...
def page1():
    """Cover + Introduction P1 only (flexbox)."""
    intro_p1_left = "Renal malignancies are among the ten most common cancers worldwide, accounting for approximately 2% of all human tumors [1]. According to global cancer statistics in 2020, about 431,288 new cases of renal cancer were diagnosed, with approximately 179,368 related deaths [2]. Clear cell renal cell carcinoma (ccRCC) is the most prevalent subtype of renal cell carcinoma, representing nearly 75% of cases [3]. Although radical or partial nephrectomy remains the primary treatment"
    intro_p1_right = "for localized ccRCC, approximately one-third of patients eventually develop distant metastases, resulting in limited therapeutic options and poor prognosis [4]. Despite advances in targeted therapies, drug resistance has emerged as a major clinical challenge, highlighting the urgent need to identify novel biomarkers and therapeutic strategies for ccRCC."
    return f'''
<div class="page">
    <div class="page-content" style="line-height:1.5;">
        ...
        <div style="margin-top:30mm;">
            ...
            <div style="display:flex;gap:var(--column-gap);text-align:justify;line-height:1.5;">
                <div style="flex:1;"><p class="no-indent">{intro_p1_left}</p></div>
                <div style="flex:1;"><p class="no-indent">{intro_p1_right}</p></div>
            </div>
        </div>
    </div>
{footer(1)}
...
def page3():
    """Methods 2.5-2.7 + Table 1 + Results 3.1."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.4;">
...
def page4():
    """Figures 1+2 (side-by-side) + Results 3.2 + Figure 3."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.4;">
...
def page6():
    """GEPIA2 validation text + Figure 5."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.4;">
...
def page7():
    """Figure 6 + Results 3.4 paragraph 1."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.4;">
...
def page8():
    """Results 3.4 paragraph 2 + Figure 7."""
    return f'''
<div class="page">
{header()}
    <div class="page-content two-column" style="line-height:1.4;">
...
if __name__ == "__main__":
    ...
    for path in [out1, out2]:
        with open(path, "w", encoding="utf-8") as f:
            f.write(html)
    print(f"Generated {len(html):,} bytes, 15 pages")
    print(f"  -> {out1}")
    print(f"  -> {out2}")
