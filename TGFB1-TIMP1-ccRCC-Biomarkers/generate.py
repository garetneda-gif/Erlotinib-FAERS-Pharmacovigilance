...
# -*- coding: utf-8 -*-
"""
Generate two-column paginated journal HTML for:
Identification of TGFB1 and TIMP1 as the Biomarkers of Clear Cell Renal Cell Carcinoma
"""

import os

IMG_BASE = "https://medbam.org/assets/TGFB1-TIMP1-ccRCC-Biomarkers/"
HEADER_TEXT = "ZHOU ET AL."
DOI = "10.65079/xxx"

# ============================================================
# CSS (from template lines 7-314, with modifications)
# ============================================================
CSS = r"""
        /* ========================================
...
def img(n):
    """Return img tag for Figure N."""
    return f'<img src="{IMG_BASE}Figure {n}.jpg" alt="Figure {n}">'


def fig(n, caption):
    """Return a full figure block."""
    return f'''<figure id="fig-{n}">
                {img(n)}
...
def side_by_side(figs):
    """figs: list of (n, caption)"""
    inner = "\n".join([f'''            <figure id="fig-{n}">
                {img(n)}
                <figcaption><span class="fig-label">Figure {n}.</span> {cap}</figcaption>
            </figure>''' for n, cap in figs])
...
def header():
    return f'    <div class="page-header">{HEADER_TEXT}</div>'
...
def tc_start():
    """Two-column page-content start."""
    return '    <div class="page-content two-column">'
...
# Figure captions
FC = {
    1: 'Volcano plots of the GSE16441, GSE110249, and GSE36895 datasets. Differentially expressed genes were identified using the thresholds of |log\u2082FC| &gt; 1 and <i>P</i> &lt; 0.05.',
    ...
    9: 'GO and KEGG enrichment analyses of genes correlated with TGFB1 (A\u2013D) and TIMP1 (E\u2013H) in the TCGA database. The top five terms for each annotation were ranked according to <i>P</i> values.',
...
# ============================================================
REFS = [
    ('[1] Turajlic S, Swanton C, Boshoff C. Kidney cancer: The next decade. J Exp Med 2018, 215(10):2477-2479.', '10.1084/jem.20181165'),
    ...
    ('[3] Atkins MB, Tannir NM. Current and emerging therapies for first-line treatment of metastatic clear cell renal cell carcinoma. Cancer Treat Rev 2018, 70:127-137.', '10.1016/j.ctrv.2018.07.009'),
    ('[4] Jonasch E, Walker CL, Rathmell WK. Clear cell renal cell carcinoma ontogeny and mechanisms of lethality. Nat Rev Nephrol 2021, 17(4):245-261.', '10.1038/s41581-020-00359-2'),
    ('[5] Severins I, Joo C, van Noort J. Exploring molecular biology in sequence space: The road to next-generation single-molecule biophysics. Mol Cell 2022, 82(10):1788-1805.', '10.1016/j.molcel.2022.04.007'),
    ('[6] Freire PP, Fernandez GJ, de Moraes D, et al. The expression landscape of cachexia-inducing factors in human cancers. J Cachexia Sarcopenia Muscle 2020, 11(4):947-961.', '10.1002/jcsm.12565'),
    ('[7] Barrett T, Troup DB, Wilhite SE, et al. NCBI GEO: archive for functional genomics data sets--10 years on. Nucleic Acids Res 2011, 39(Database issue):D1005-1010.', '10.1093/nar/gkq1184'),
    ('[8] The Gene Ontology Consortium. The Gene Ontology Resource: 20 years and still GOing strong. Nucleic Acids Res 2019, 47(D1):D330-D338.', '10.1093/nar/gky1055'),
    ('[9] Kanehisa M, Furumichi M, Tanabe M, et al. KEGG: new perspectives on genomes, pathways, diseases and drugs. Nucleic Acids Res 2017, 45(D1):D353-D361.', '10.1093/nar/gkw1092'),
    ('[10] Chen L, Lu D, Sun K, et al. Identification of biomarkers associated with diagnosis and prognosis of colorectal cancer patients based on integrated bioinformatics analysis. Gene 2019, 692:119-125.', '10.1016/j.gene.2019.01.001'),
    ('[11] Otasek D, Morris JH, Boucas J, et al. Cytoscape Automation: empowering workflow-based network analysis. Genome Biol 2019, 20(1):185.', '10.1186/s13059-019-1758-4'),
    ('[12] Fang HT, El Farran CA, Xing QR, et al. Global H3.3 dynamic deposition defines its bimodal role in cell fate transition. Nat Commun 2018, 9(1):1537.', '10.1038/s41467-018-03904-7'),
    ('[13] Su W, Zhao Y, Wei Y, et al. Exploring the Pathogenesis of Psoriasis Complicated With Atherosclerosis via Microarray Data Analysis. Front Immunol 2021, 12:667690.', '10.3389/fimmu.2021.667690'),
    ('[14] Huang X, Tang T, Zhang G, et al. Identification of tumor antigens and immune subtypes of cholangiocarcinoma for mRNA vaccine development. Mol Cancer 2021, 20(1):50.', '10.1186/s12943-021-01342-6'),
    ('[15] Chandrashekar DS, Bashel B, Balasubramanya SAH, et al. UALCAN: A Portal for Facilitating Tumor Subgroup Gene Expression and Survival Analyses. Neoplasia 2017, 19(8):649-658.', '10.1016/j.neo.2017.05.002'),
    ('[16] Sun CC, Li SJ, Hu W, et al. Comprehensive Analysis of the Expression and Prognosis for E2Fs in Human Breast Cancer. Mol Ther 2019, 27(6):1153-1165.', '10.1016/j.ymthe.2019.03.019'),
    ('[17] Di W, Fan W, Wu F, et al. Clinical characterization and immunosuppressive regulation of CD161 (KLRB1) in glioma through 916 samples. Cancer Sci 2022, 113(2):756-769.', '10.1111/cas.15236'),
    ('[18] Li X, Wei S, Niu S, et al. Network pharmacology prediction and molecular docking-based strategy to explore the potential mechanism of Huanglian Jiedu Decoction against sepsis. Comput Biol Med 2022, 144:105389.', '10.1016/j.compbiomed.2022.105389'),
    ('[19] Rydzanicz M, Wrzesinski T, Bluyssen HA, et al. Genomics and epigenomics of clear cell renal cell carcinoma: recent developments and potential applications. Cancer Lett 2013, 341(2):111-126.', '10.1016/j.canlet.2013.08.006'),
    ('[20] Phallen J, Sausen M, Adleff V, et al. Direct detection of early-stage cancers using circulating tumor DNA. Sci Transl Med 2017, 9(403).', '10.1126/scitranslmed.aan2415'),
    ('[21] Henze AT, Acker T. Feedback regulators of hypoxia-inducible factors and their role in cancer biology. Cell Cycle 2010, 9(14):2749-2763.', '10.4161/cc.9.14.12591'),
    ('[22] Cowman SJ, Fuja DG, Liu X-D, et al. Macrophage HIF-1\u03b1 Is an Independent Prognostic Indicator in Kidney Cancer. Clin Cancer Res 2020, 26(18):4970-4982.', '10.1158/1078-0432.CCR-19-3500'),
    ('[23] Reustle A, Di Marco M, Meyerhoff C, et al. Integrative -omics and HLA-ligandomics analysis to identify novel drug targets for ccRCC immunotherapy. Genome Med 2020, 12(1):32.', '10.1186/s13073-020-00731-8'),
    ('[24] Schaeffeler E, Buttner F, Reustle A, et al. Metabolic and Lipidomic Reprogramming in Renal Cell Carcinoma Subtypes Reflects Regions of Tumor Origin. Eur Urol Focus 2019, 5(4):608-618.', '10.1016/j.euf.2018.01.016'),
    ('[25] He B, Xu T, Pan B, et al. Polymorphisms of TGFBR1, TLR4 are associated with prognosis of gastric cancer in a Chinese population. Cancer Cell Int 2018, 18:191.', '10.1186/s12935-018-0682-0'),
    ('[26] Takahara T, Tsuyuki T, Satou A, et al. TGFB1 mRNA expression is associated with poor prognosis and specific features of inflammation in ccRCC. Virchows Arch 2022, 480(3):635-643.', '10.1007/s00428-021-03236-2'),
    ('[27] Sun S, Su D, Dong T, et al. Mitochondrial ribosomal protein L12 mediates metabolic reorganization in clear cell renal cell carcinoma by regulating mitochondrial biosynthesis. Cell Commun Signal 2025, 23(1):435.', '10.1186/s12964-025-02128-x'),
    ('[28] Wu P, Geng B, Chen Q, et al. Tumor Cell-Derived TGFbeta1 Attenuates Antitumor Immune Activity of T Cells via Regulation of PD-1 mRNA. Cancer Immunol Res 2020, 8(12):1470-1484.', '10.1158/2326-6066.CIR-20-0063'),
    ('[29] Chang NS. Transforming growth factor-beta protection of cancer cells against tumor necrosis factor cytotoxicity is counteracted by hyaluronidase (review). Int J Mol Med 1998, 2(6):653-659.', '10.3892/ijmm.2.6.653'),
    ('[30] Dias F, Teixeira AL, Nogueira I, et al. Plasma Extracellular Vesicle-Derived TIMP-1 mRNA as a Prognostic Biomarker in Clear Cell Renal Cell Carcinoma: A Pilot Study. Int J Mol Sci 2020, 21(13).', '10.3390/ijms21134624'),
    ('[31] Dias F, Teixeira AL, Nogueira I, et al. Plasma Extracellular Vesicle-Derived TIMP-1 mRNA as a Prognostic Biomarker in Clear Cell Renal Cell Carcinoma: A Pilot Study. Int J Mol Sci 2020, 21(13).', '10.3390/ijms21134624'),
    ('[32] Shang L, Liu HJ, Hao JJ, et al. A panel of overexpressed proteins for prognosis in esophageal squamous cell carcinoma. PLoS One 2014, 9(10):e111045.', '10.1371/journal.pone.0111045'),
    ('[33] Thomas DD, Heinecke JL, Ridnour LA, et al. Signaling and stress: The redox landscape in NOS2 biology. Free Radic Biol Med 2015, 87:204-225.', '10.1016/j.freeradbiomed.2015.06.002'),
    ('[34] Chen J, Gu Y, Lin F, et al. Endothelin receptor antagonist combined with a calcium channel blocker attenuates renal injury in spontaneous hypertensive rats with diabetes. Chin Med J (Engl) 2002, 115(7):972-978.', None),
    ('[35] Tzanidis A, Lim S, Hannan RD, et al. Combined angiotensin and endothelin receptor blockade attenuates adverse cardiac remodeling post-myocardial infarction in the rat: possible role of transforming growth factor beta(1). J Mol Cell Cardiol 2001, 33(5):969-981.', '10.1006/jmcc.2001.1359'),
    ('[36] Soldano S, Pizzorni C, Paolino S, et al. Alternatively Activated (M2) Macrophage Phenotype Is Inducible by Endothelin-1 in Cultured Human Macrophages. PLoS One 2016, 11(11):e0166433.', '10.1371/journal.pone.0166433'),
    ('[37] Caputo I, Caroccia B, Frasson I, et al. Angiotensin II Promotes SARS-CoV-2 Infection via Upregulation of ACE2 in Human Bronchial Cells. Int J Mol Sci 2022, 23(9).', '10.3390/ijms23095125'),
    ('[38] Gross O, Beirowski B, Koepke ML, et al. Preemptive ramipril therapy delays renal failure and reduces renal fibrosis in COL4A3-knockout mice with Alport syndrome. Kidney Int 2003, 63(2):438-446.', '10.1046/j.1523-1755.2003.00779.x'),
    ('[39] Gohil VM, Offner N, Walker JA, et al. Meclizine is neuroprotective in models of Huntington\'s disease. Hum Mol Genet 2011, 20(2):294-300.', '10.1093/hmg/ddq464'),
    ('[40] Hosohata K, Quock RM, Hosohata Y, et al. AM630 is a competitive cannabinoid receptor antagonist in the guinea pig brain. Life Sci 1997, 61(9):PL115-118.', '10.1016/S0024-3205(97)00596-1'),
]


def ref_html(text, doi):
    if doi:
        return f'<div>{text} DOI: <a href="https://doi.org/{doi}" target="_blank">{doi}</a></div>'
    else:
...
# ========================= PAGE 1 =========================
# Cover page + Introduction P1-P2 (flexbox manual two-column)
p1 = f"""{page_start()}
    <div class="page-content">
        <div id="cover">
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-end;font-size:7pt;border-bottom:0.5pt solid #000;padding-bottom:1mm;margin-bottom:2mm;">
                <div style="flex:1;">February 2026 <span style="margin-left:2em;">DOI: {DOI}</span></div>
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6mm;">
                <div style="font-size:10pt;font-weight:bold;letter-spacing:0.06em;text-transform:uppercase;margin-top:2mm;color:#000;border-bottom:1.5pt solid #000;padding-bottom:1mm;display:inline-block;">ORIGINAL ARTICLE</div>
                <img src="https://medbam.org/assets/logo.png" alt="MedBA Logo" style="height:38px;width:auto;display:block;">
            </div>

            <!-- 标题 -->
            <div id="article-title" style="font-size:18pt;font-weight:bold;margin-bottom:8mm;line-height:1.2;text-align:left;">
                Identification of TGFB1 and TIMP1 as the Biomarkers of Clear Cell Renal Cell Carcinoma by Bioinformatic Methods
            </div>

            <!-- 作者 -->
            <div id="article-authors" style="font-size:11pt;margin-bottom:10mm;font-weight:normal;text-align:left;">
                Lifang Zhou<sup>1</sup>, Nana Li<sup>1</sup>, Yiying Zhang<sup>1</sup>, Hongling Hu<sup>1</sup>, Hongjian Zhang<sup>1,#</sup>
            </div>
            ...
            <div id="front-matter" style="display:flex;margin-bottom:8mm;align-items:stretch;">
                ...
                <div style="width:30%;font-size:8pt;line-height:1.3;padding:4mm 4mm 4mm 0;border-right:0.5pt solid #000;">
                    <p style="margin:0 0 3mm 0;text-indent:0;text-align:left;">
                        <span style="vertical-align:super;font-size:0.7em;line-height:0;">1</span> Department of Cancer, Zhongshan Hospital of Xiamen University, Xiamen, China.
                    </p>
                    <p style="margin:0 0 3mm 0;text-indent:0;text-align:left;">
                        <span style="font-weight:bold;display:block;margin-bottom:1mm;">Correspondence</span>
                        Hongjian Zhang, MD, Zhongshan Hospital of Xiamen University, Xiamen, 361000, China.<br>
                        Email: zhanghongjian11021@163.com
                    </p>
                    <p style="margin:0 0 3mm 0;text-indent:0;text-align:left;">
                        <span style="font-weight:bold;display:block;margin-bottom:1mm;">Funding information</span>
                        This study was supported by the Xiamen Medical and Health Guidance Project, China (Grant NO. 3502Z20254ZD1124).
                    </p>
                </div>

                <!-- 右栏：摘要 -->
                <div id="abstract-box" style="width:70%;padding:4mm 4mm 4mm 4mm;position:relative;background-color:#f8f9fa;">
                    ...
                    <div id="abstract-body" style="font-size:9pt;line-height:1.3;">
                        ...
                        <div style="margin-top:2mm;">
                            <span style="font-weight:bold;">Keywords:</span> Clear cell renal cell carcinoma, Metastasis, Biomarkers, Active drugs, Molecular docking
                        </div>
                    </div>
                </div>
            </div>

            <!-- Introduction (flexbox手动分栏, 只有2段) -->
            <div style="display:flex;gap:7.48mm;">
                <div style="flex:1;">
                    <h1 class="section-title" style="margin-top:0;">1 INTRODUCTION</h1>
...
# ========================= PAGE 3 =========================
# Methods 2.4-2.7 + Results 3.1 + Table 1
p3 = f"""{page_start()}
{header()}
{tc_start()}
        ...
        <p class="no-indent">Transcriptional and clinical data of 613 ccRCC samples were obtained from the TCGA database (https://portal.gdc.cancer.gov/). Data preprocessing was performed in R software, which included removal of duplicate samples, exclusion of samples with missing clinical or expression data, and normalization by log&#8322; transformation. The final expression matrix consisted of 532 ccRCC samples and 72 normal renal tissue samples. The <i>pheatmap</i> package in R was used to visualize the relationship between key genes and clinical parameters. Receiver operating characteristic (ROC) curves were generated using the <i>pROC</i> package to evaluate the expression specificity of the key genes in ccRCC. Pearson correlation analysis was performed to identify genes co-expressed with the key genes, and those with a Pearson correlation coefficient &gt; 0.5 were selected for enrichment analysis to explore the potential biological functions of the key genes [17].</p>
        ...
        <p class="no-indent">Statistical analyses were performed using R software. The differences in gene expression across clinical subgroups were assessed using the Student&rsquo;s t-test. A two-sided P value &lt; 0.05 was considered statistically significant.</p>

        <h1 class="section-title">3 RESULTS</h1>

        <h2 class="subsection-title">3.1 Identification of DEGs</h2>
        <p class="no-indent">The GSE11024, GSE16441, and GSE36895 datasets were downloaded from the GEO database. This study included 10 ccRCC and 12 normal tissue samples from GSE11024, 17 ccRCC and 17 normal samples from GSE16441, and 23 ccRCC and 23 normal samples from GSE36895 (Table 1). Differentially expressed genes (DEGs) in each dataset were identified using the GEO2R online tool, with the cut-off criteria set as |log&#8322; fold change (FC)| &gt; 1 and P &lt; 0.05. Volcano plots illustrating the DEGs in each dataset are shown in Figure 1. The overlap of up-regulated (Figure 2A) and down-regulated (Figure 2B) DEGs among the three datasets was visualized using Venn diagrams. In total, 608 shared DEGs were identified, including 267 up-regulated and 341 down-regulated genes (Supplementary Table 1).</p>

        <!-- Table 1: 4 columns -> span all -->
...
# ========================= PAGE 4 =========================
# Figure 1+2 (side by side) + Results 3.2 + Figure 3
p4 = f"""{page_start()}
{header()}
{tc_start()}
        {side_by_side([(1, FC[1]), (2, FC[2])])}
...
# ========================= PAGE 5 =========================
# Results 3.3 P1 + Figure 4 + 3.3 P2 start
p5 = f"""{page_start()}
{header()}
{tc_start()}
...
{tc_start()}
        ...
        <p>The heatmaps indicated that TGFB1 (Figure 7A) and TIMP1 (Figure 7B) were more highly expressed in advanced stages of ccRCC. Boxplot analyses further demonstrated that TGFB1 and TIMP1 expression levels were significantly elevated in stage III&ndash;IV compared to stage I&ndash;II (P = 0.0093) and in T3&ndash;T4 compared to T1&ndash;T2 (P = 0.0021) (Figure 7C, 7D). Moreover, TIMP1 expression was significantly higher in N1 compared to N0 (P = 0.033) and in M1 compared to M0 (P = 0.0003) (Figure 7D). In contrast, TGFB1 expression did not show significant differences across N or M stages (Figure 7C). These results suggest that TGFB1 and TIMP1 are associated with tumor progression in ccRCC, with TIMP1 exhibiting a broader correlation with TNM components.</p>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;">Combined Score</th>
                        <th style="text-align:center;">Genes</th>
                    </tr>
                </thead>
                <tbody>
                    <tr><td>Bosentan</td><td>00003071</td><td style="text-align:center;">5.50E-04</td><td style="text-align:center;">150029.821</td><td style="text-align:center;">TGFB1</td></tr>
                    <tr><td>Ramipril</td><td>00007148</td><td style="text-align:center;">5.50E-04</td><td style="text-align:center;">150029.821</td><td style="text-align:center;">TGFB1</td></tr>
                    <tr><td>Meclizine</td><td>00006252</td><td style="text-align:center;">5.50E-04</td><td style="text-align:center;">150029.821</td><td style="text-align:center;">TIMP1</td></tr>
                    <tr><td>AM-630</td><td>00003207</td><td style="text-align:center;">6.50E-04</td><td style="text-align:center;">146675.8762</td><td style="text-align:center;">TIMP1</td></tr>
                </tbody>
            </table>
        </div>
...
{tc_start()}
        ...
        <p>After the construction of the PPI network of shared DEGs, the top 10 hub genes were identified. The expressional differences of 9 hub genes between ccRCC tissues and normal tissues were consistence with the results of the GEPIA2 database. A total of 6 genes including FN1, TIMP1, VEGFA, TGFB1, PECAM1, and CAV1 were up-regulated in ccRCC, in which TGFB1 and TIMP1 were found to be correlated with the progression and prognosis of ccRCC. In the TCGA database, we further proved that TGFB1 and TIMP1 were highly expressed in the higher TNM stage of ccRCC and showed good expression specificity in ccRCC, which suggested that TGFB1 and TIMP1 may be the potential biomarkers of ccRCC.</p>
{tc_end()}
{footer(11)}
{page_end()}"""
pages.append(p11)
...
# ========================= PAGE 14 =========================
# References 1-20
refs_14 = "\n".join([f"            {ref_html(t, d)}" for t, d in REFS[:20]])
p14 = f"""{page_start()}
{header()}
{tc_start()}
...
# Write output
output_path = "/Users/jikunren/Documents/期刊排版/TGFB1-TIMP1-ccRCC-Biomarkers/双栏分页-TGFB1-TIMP1-ccRCC-Biomarkers.html"
