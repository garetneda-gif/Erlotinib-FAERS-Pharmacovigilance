...
<head>
    ...
    <style>
        ...
        * {
        ...
        .footnote-item {
            text-indent: 0; /* 根据要求调整 */
            padding-left: 1em; /* 悬挂缩进 */
            text-indent: -1em;
        }
        .footnote-mark {
    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="footnote-area">
                <div class="footnote-item"><span class="footnote-mark">①</span> 这是第一页的脚注示例，通常使用楷体和小字号。</div>
                <div class="footnote-item"><span class="footnote-mark">②</span> 脚注区域位于页面底部，上方有分隔线。</div>
            </div>
...
output_path = '/Users/jikunren/.config/opencode/skills/历史研究格式排版/assets/template-two-column.html'
