...
<head>
    ...
    <title>{SHORT_TITLE} - MedBA Medicine (Online View)</title>
    {single_column_css}
</head>
<body>

<div style="text-align:center;padding:5mm 0;border-bottom:2px solid #005a8c;margin-bottom:6mm;">
    <div style="text-decoration:underline;font-weight:bold;font-size:11pt;margin-bottom:3mm;">ORIGINAL ARTICLE</div>
</div>
...
<div style="margin:6mm 0;font-size:10pt;">
...
<div class="abstract-section">
    ...
    <div style="margin:3mm 0;">
        <strong style="font-size:10pt;">Background</strong><br>
    ...
    <div style="margin:3mm 0;">
        <strong style="font-size:10pt;">Materials and Methods</strong><br>
        <div class="abstract-content">
    ...
    <div style="margin:3mm 0;">
        <strong style="font-size:10pt;">Results</strong><br>
        <div class="abstract-content">
...
<div style="display:flex;gap:5mm;margin:5mm 0;align-items:flex-end;break-inside:avoid;page-break-inside:avoid;">
    <figure id="fig-1" style="flex:1.2;margin:0;display:flex;flex-direction:column;">
        <img src="{FIGURE_URLS[1]}" alt="Figure 1" style="width:100%;height:auto;max-width:100%;max-height:120mm;object-fit:contain;display:block;">
        <figcaption style="font-size:8.5pt;margin-top:2mm;text-align:left;line-height:1.3;color:#222;">
            <span style="font-weight:bold;color:#005a8c;">Figure 1.</span> {figure_captions[1]}
        </figcaption>
    </figure>
    <figure id="fig-2" style="flex:0.8;margin:0;display:flex;flex-direction:column;">
        <img src="{FIGURE_URLS[2]}" alt="Figure 2" style="width:100%;height:auto;max-width:100%;max-height:120mm;object-fit:contain;display:block;">
        <figcaption style="font-size:8.5pt;margin-top:2mm;text-align:left;line-height:1.3;color:#222;">
            <span style="font-weight:bold;color:#005a8c;">Figure 2.</span> {figure_captions[2]}
        </figcaption>
    </figure>
</div>
...
<figure id="fig-3" style="margin:5mm 0;break-inside:avoid;">
    <img src="{FIGURE_URLS[3]}" alt="Figure 3" style="width:100%;height:auto;max-width:100%;max-height:120mm;object-fit:contain;display:block;">
...
<figure id="fig-4" style="margin:5mm 0;break-inside:avoid;">
    <img src="{FIGURE_URLS[4]}" alt="Figure 4" style="width:100%;height:auto;max-width:100%;max-height:120mm;object-fit:contain;display:block;">
...
<div class="references-section">
    <div class="ref-item">[1] Ferlay J, Shin H R, Bray F, et al. Estimates of worldwide burden of cancer in 2008: GLOBOCAN 2008[J]. Int J Cancer, 2010,127(12):2893-917.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Ferlay+Estimates+worldwide+burden+cancer+2008+GLOBOCAN" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[2] Bhatla N,Singhal S. Primary HPV screening for cervical cancer[J]. Best Pract Res Clin Obstet Gynaecol, 2020,65:98-108.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Bhatla+Primary+HPV+screening+cervical+cancer" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[3] Ortiz-de la Tabla V,Gutierrez F. Cervicitis: Etiology, diagnosis and treatment[J]. Enferm Infecc Microbiol Clin (Engl Ed), 2019,37(10):661-67.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Ortiz-de+la+Tabla+Cervicitis+Etiology+diagnosis+treatment" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[4] Hirschhorn T,Stockwell B R. The development of the concept of ferroptosis[J]. Free Radic Biol Med, 2019,133:130-43.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Hirschhorn+Stockwell+development+concept+ferroptosis" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[5] Dixon S, Lemberg K, Lamprecht M, et al. Ferroptosis: an iron-dependent form of nonapoptotic cell death[J]. Cell, 2012, 149(5). DOI:10.1016/j.cell.2012.03.042.
    <div class="ref-links">
        <a href="https://doi.org/10.1016/j.cell.2012.03.042" target="_blank">DOI</a>
        <a href="https://scholar.google.com/scholar?q=Dixon+Ferroptosis+iron-dependent+nonapoptotic+cell+death" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[6] Stockwell B R, Jiang X, Gu W. Emerging Mechanisms and Disease Relevance of Ferroptosis[J]. Trends Cell Biol, 2020,30(6):478-90.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Stockwell+Emerging+Mechanisms+Disease+Relevance+Ferroptosis" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[7] Liang C, Zhang X, Yang M, et al. Recent Progress in Ferroptosis Inducers for Cancer Therapy[J]. Adv Mater, 2019,31(51):e1904197.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Liang+Recent+Progress+Ferroptosis+Inducers+Cancer+Therapy" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[8] Ma S, Henson E S, Chen Y, et al. Ferroptosis is induced following siramesine and lapatinib treatment of breast cancer cells[J]. Cell Death Dis, 2016,7:e2307.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Ma+Ferroptosis+induced+siramesine+lapatinib+breast+cancer" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[9] Xiaofei J, Mingqing S, Miao S, et al. Oleanolic acid inhibits cervical cancer Hela cell proliferation through modulation of the ACSL4 ferroptosis signaling pathway[J]. Biochem Biophys Res Commun, 2021,545:81-88.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Xiaofei+Oleanolic+acid+cervical+cancer+ACSL4+ferroptosis" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[10] Huang W, Zeng C, Hu S, et al. ATG3, a Target of miR-431-5p, Promotes Proliferation and Invasion of Colon Cancer via Promoting Autophagy[J]. Cancer Manag Res, 2019,11:10275-85.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Huang+ATG3+Target+miR-431-5p+Colon+Cancer+Autophagy" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[11] Fortunato F, Burgers H, Bergmann F, et al. Impaired autolysosome formation correlates with Lamp-2 depletion: role of apoptosis, autophagy, and necrosis in pancreatitis[J]. Gastroenterology, 2009,137(1):350-60, 60 e1-5.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Fortunato+Impaired+autolysosome+Lamp-2+pancreatitis" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[12] Liao Y P, Chen L Y, Huang R L, et al. Hypomethylation signature of tumor-initiating cells predicts poor prognosis of ovarian cancer patients[J]. Hum Mol Genet, 2014,23(7):1894-906.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Liao+Hypomethylation+tumor-initiating+ovarian+cancer" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[13] Suwazono S, Arao H. A newly developed free software tool set for averaging electroencephalogram implemented in the Perl programming language[J]. Heliyon, 2020,6(11):e05580.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Suwazono+software+electroencephalogram+Perl" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[14] Chan B K C. Data Analysis Using R Programming[J]. Adv Exp Med Biol, 2018,1082:47-122.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Chan+Data+Analysis+R+Programming" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[15] Zhou N, Bao J. FerrDb: a manually curated resource for regulators and markers of ferroptosis and ferroptosis-disease associations[J]. Database (Oxford), 2020,2020.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Zhou+FerrDb+ferroptosis+regulators+markers" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[16] Simon N, Friedman J, Hastie T, et al. Regularization Paths for Cox's Proportional Hazards Model via Coordinate Descent[J]. J Stat Softw, 2011,39(5):1-13.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Simon+Regularization+Cox+Proportional+Hazards+Coordinate+Descent" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[17] Cai W, van der Laan M. Nonparametric bootstrap inference for the targeted highly adaptive least absolute shrinkage and selection operator (LASSO) estimator[J]. Int J Biostat, 2020.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Cai+van+der+Laan+Nonparametric+bootstrap+LASSO" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[18] Huang R, Liao X, Li Q. Identification and validation of potential prognostic gene biomarkers for predicting survival in patients with acute myeloid leukemia[J]. Onco Targets Ther, 2017,10:5243-54.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Huang+Liao+prognostic+biomarkers+acute+myeloid+leukemia" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[19] Zhou B, Jin W. Visualization of Single Cell RNA-Seq Data Using t-SNE in R[J]. Methods Mol Biol, 2020,2117:159-67.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Zhou+Jin+Visualization+Single+Cell+RNA-Seq+t-SNE" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[20] Wang S, Su W, Zhong C, et al. An Eight-CircRNA Assessment Model for Predicting Biochemical Recurrence in Prostate Cancer[J]. Front Cell Dev Biol, 2020,8:599494.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Wang+Eight-CircRNA+Prostate+Cancer+Biochemical+Recurrence" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[21] Dennis G, Jr., Sherman B T, Hosack D A, et al. DAVID: Database for Annotation, Visualization, and Integrated Discovery[J]. Genome Biol, 2003,4(5):P3.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Dennis+DAVID+Database+Annotation+Visualization" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[22] Kanehisa M, Goto S. KEGG: kyoto encyclopedia of genes and genomes[J]. Nucleic Acids Res, 2000,28(1):27-30.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Kanehisa+Goto+KEGG+kyoto+encyclopedia+genes+genomes" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[23] Gene Ontology C. The Gene Ontology project in 2008[J]. Nucleic Acids Res, 2008,36(Database issue):D440-4.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Gene+Ontology+project+2008" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[24] Szklarczyk D, Morris J H, Cook H, et al. The STRING database in 2017: quality-controlled protein-protein association networks, made broadly accessible[J]. Nucleic Acids Res, 2017,45(D1):D362-D68.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Szklarczyk+STRING+database+2017+protein-protein" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[25] Spainhour J C G, Lim J, Qiu P. GDISC: a web portal for integrative analysis of gene-drug interaction for survival in cancer[J]. Bioinformatics, 2017,33(9):1426-28.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Spainhour+GDISC+gene-drug+interaction+survival+cancer" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[26] Zhao J Y, Li X Y, Liu T D, et al. Silencing of ATG4D suppressed proliferation and enhanced cisplatin-induced apoptosis in hepatocellular carcinoma through Akt/Caspase-3 pathway[J]. Mol Cell Biochem, 2021,476(11):4153-59.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Zhao+Silencing+ATG4D+cisplatin+hepatocellular+carcinoma" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[27] Li H, Qi J, Wei J, et al. Long non-coding RNA ANRIL mitigates neonatal hypoxic-ischemic brain damage via targeting the miR-378b/ATG3 axis[J]. Am J Transl Res, 2021,13(10):11585-96.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Li+ANRIL+hypoxic-ischemic+brain+miR-378b+ATG3" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[28] Seo J, Yun J, Fukuda J, et al. Tumor-intrinsic FABP5 is a novel driver for colon cancer cell growth via the HIF-1 signaling pathway[J]. Cancer Genet, 2021,258-259:151-56.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Seo+FABP5+colon+cancer+HIF-1+signaling" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[29] Alanazi A E, Awadalla M, Alowaini A, et al. Exploring the interplay between EBV and autophagy-related gene expression patterns in nasopharyngeal carcinoma[J]. 2025.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Alanazi+EBV+autophagy+nasopharyngeal+carcinoma" target="_blank">Google Scholar</a>
    </div></div>
    
    <div class="ref-item">[30] Zheng L, Yang Z, Xue Z, et al. Air--Liquid Interface Microfluidic Monitoring Sensor Platform for Studying Autophagy Regulation after PM2.5 Exposure[J]. ACS sensors, 2024, 9(3): 1178-118.
    <div class="ref-links">
        <a href="https://scholar.google.com/scholar?q=Zheng+Air+Liquid+Interface+Microfluidic+Autophagy+PM2.5" target="_blank">Google Scholar</a>
    </div></div>
</div>
...
single_column_output = os.path.join(OUTPUT_DIR, f"单栏连续-{SHORT_TITLE}.html")

with open(single_column_output, 'w', encoding='utf-8') as f:
    f.write(html)

file_size = os.path.getsize(single_column_output) / 1024
print("   ├─ 内容组装: ✅")
print(f"   └─ 文件写入: ✅ ({file_size:.1f} KB)")

print("\n✅ 单栏连续HTML生成完成!")
print(f"   输出路径: {single_column_output}")
print(f"\n🎉 所有排版任务完成!")
print(f"\n生成文件：")
print(f"   1. 双栏分页版（PDF打印）: 双栏分页-{SHORT_TITLE}.html")
print(f"   2. 单栏连续版（在线预览）: 单栏连续-{SHORT_TITLE}.html")
print(f"\n图片URL格式：")
print(f"   {BASE_URL}/Figure [1-4].png")
